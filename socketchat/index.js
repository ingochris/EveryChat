  ...
  request('https://api.everyblock.com/content/philly/locations/19104/timeline/?token=d57c38793098b0e9a92adee4ee9ca7b20a8fb036', function(error, response, body) {
    if (!error && response.statusCode == 200) {
      ...
      for (step = 0; step < 25; step++) {
        ...
        newEveryblock.push({latitude: latitude, longitude: longitude, location: location, date: date});
      }
      
      var same = everyblock.every(function(element, index) {
          return element === newEveryblock[index]; 
      });
